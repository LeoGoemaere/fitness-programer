...
<template>
  <UModal
    ...
    :ui="modalUi"
  >
    <UCard :ui="{ base: 'h-full flex flex-col', body: { base: 'border-solid flex-1 border-b-none' }, footer: { base: 'sticky bottom-0 bg-white', padding: 'p-0' } }">
      <template #header>
      ...
      <slot name="default" />
      <template #footer>
        <div class="footer-action justify-center flex px-4 py-4 sm:px-6">
